...
public class Point33D implements Serializable {
	...
	public Point33D(int x, int y, int z) {
		super();
		this.axisX = x;
		this.axisY = y;
		this.axisZ = z;
	...
	public void translate(Point33D originP,Point33D traslateP) {
	...
	public void rotate(Point33D p, boolean x, boolean y, boolean z) {
	...
	public void scale(Point33D p, int s) {
		p.axisX = p.axisX * s;
		p.axisY = p.axisY * s;
		p.axisZ = p.axisZ * s;
